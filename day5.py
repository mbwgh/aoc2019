...
does nothing. Opcode 6 is jump-if-false: if the first parameter is zero, it
sets the instruction pointer to the value from the second parameter.
Otherwise, it does nothing. Opcode 7 is less than: if the first parameter
is less than the second parameter, it stores 1 in the position given by the
third parameter. Otherwise, it stores 0. Opcode 8 is equals: if the first
parameter is equal to the second parameter, it stores 1 in the position
...
def main1():
    """Read file `day5-input` and evaluate it."""
    output = []
    ...
    computer = Computer("day5-input", lambda: 1, out)
    computer.evaluate()
    print(output)
...
def main2():
    ...
    computer = Computer("day5-input", lambda: 5, out)
    computer.evaluate()
    print(output)
